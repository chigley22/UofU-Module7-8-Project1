...
function getHourlyWeatherApi(position) {
    ...
    for (let i = 0; i <= 5; i++) {
        ...
        // iconWeather.innerHTML = hourly.weather.icon
        ...
        // createTableDataIcon.appendChild(iconWeather)
        ...
        // createTableRow.appendChild(createTableDataIcon)
